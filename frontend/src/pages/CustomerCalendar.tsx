          ...
          <div className="bg-gradient-to-r from-[#4A5D23]/10 via-[#D4AF37]/10 to-[#8B7355]/10 px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-12 border-b-2 border-[#D4AF37]/30 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-between mb-4">
                ...
                <button
                  onClick={handleBack}
                  className="px-4 py-2 text-sm sm:text-base text-[#6B7C4A] hover:text-[#D4AF37] border border-[#D4AF37]/30 hover:border-[#D4AF37] rounded-md transition-colors duration-300 font-light whitespace-nowrap"
                >
                  ← Back to Dashboard
                </button>
              </div>
